...
public class Main {
    ...
    private static Map<Integer, L13DefiningClasses.bank.BankAccount> bankAccounts;
        ...
        while (! "End".equals(input = reader.readLine())) {
            ...
            switch (command) {
                ...
                case "Print":
                    ...
                    break;
                case "SetInterest":
                    L13DefiningClasses.bank.BankAccount.setInterest(Double.parseDouble(tokens[1]));
                    break;
                case "GetInterest":
    ...
    private static void createAccount() {
        L13DefiningClasses.bank.BankAccount bankAccount = new L13DefiningClasses.bank.BankAccount();
